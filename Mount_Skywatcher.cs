...
namespace BasicApi
{
    public class Mount_Skywatcher : Mount
    {
        ...
        {            
            ...
            //Console.WriteLine(LOW_SPEED_MARGIN.ToString());
        ...
        public void getXStepperValue() //mcs
        {
            //string response = TalkWithAxis(AXISID.AXIS1, 'i', null);
           // Console.WriteLine("Response " + response);
            //GlobalVariables.lastStepperX = Convert.ToInt64(response);
        }

        public void getYStepperValue() //mcs
        {
            //string response = TalkWithAxis(AXISID.AXIS2, 'i', null);
            //Console.WriteLine("Response " + response);
            //GlobalVariables.lastStepperY = Convert.ToInt64(response);
        }
        public void addXAxisLoc(long newItem) //mcs
        {
            if (GlobalVariables.xLocReadings.Count >= 3)
                GlobalVariables.xLocReadings.RemoveAt(2);
            GlobalVariables.xLocReadings.Insert(0, newItem);
        }
        ...
        public override void MCAxisSlew(AXISID Axis, double Speed)
        {
            ...
            if (Speed > MAX_SPEED)                  // 3.4 degrees/sec, 800X sidereal rate, is the highest speed.
                ...
                Speed = -MAX_SPEED;
            Console.WriteLine("LOW SPEED MARGIN: " + LOW_SPEED_MARGIN);
            float InternalSpeed = (float)Speed;
            ...
            {						// High speed adjustment
                InternalSpeed = InternalSpeed / HighSpeedRatio[(int)Axis];
                highspeed = true;
            }
            ...
            Console.WriteLine("NEW MOTOR SPEED: " + SpeedInt.ToString());
        ...
        public override void MCAxisSlewTo(AXISID Axis, double TargetPosition)
        {
            ...
            //Console.WriteLine("Current Position: " + CurPosition);
            ...
            Console.WriteLine("movingsteps: " + MovingSteps);
            Console.WriteLine("movingangle: " + MovingAngle);
            bool forward = false, highspeed = false;
            ...
            */
            ...
            bool forward = false;
            long tp = Convert.ToInt64(TargetPosition);
            SetGotoTarget(Axis, tp);
            StartMotion(Axis);
        ...
        public override void MCSetAxisPosition(AXISID Axis, double NewValue)
        {
            ...
            Console.WriteLine("NewStepIndex = " + NewStepIndex);
            string szCmd = longTo6BitHEX(NewStepIndex);
            Console.WriteLine("Sizecmd: " + szCmd);
        ...
        public override double MCGetAxisPosition(AXISID Axis)
        {
            ...
            string name = Axis.ToString(); //mcs
            long iPosition = BCDstr2long(response);
            iPosition -= 0x00800000;
            Positions[(int)Axis] = StepToAngle(Axis, iPosition);
            if(Axis == AXISID.AXIS1) { GlobalVariables.lastXAxisReading = iPosition; }
            if(Axis == AXISID.AXIS2) { GlobalVariables.lastYAxisReading = iPosition; }
            //Console.WriteLine("Axis " + name + " position: " + iPosition); //mcs
        ...
        public long BCDstr2long(string str) //mcs public
        {
            // =020782 => 8521474
            try
            {
        ...
        public string longTo6BitHEX(long number)
        {
            // 31 -> 0F0000
        ...
        public void InquireMotorBoardVersion(AXISID Axis) //mcs public
        {
            ...
            string blah = MCVersion.ToString();
            Console.WriteLine("MOTOR CONTROL VERSION: " + response);
        ...
        public void SetMotionMode(AXISID Axis, char func, char direction)
        {
            string szCmd = "" + func + direction;
            TalkWithAxis(Axis, 'G', szCmd);
        }

        public void SetGotoTarget(AXISID Axis, long targetLocation)  //mcs
        {
           
            targetLocation += 0x800000;
            Console.WriteLine("Target Location: " + targetLocation);
            string szCmd = longTo6BitHEX(targetLocation);
            Console.WriteLine("Sizecmd: " + szCmd);
            TalkWithAxis(Axis, 'S', szCmd);
        ...
        public void SetStepPeriod(AXISID Axis, long StepsCount) 
        {
            string szCmd = longTo6BitHEX(StepsCount);
